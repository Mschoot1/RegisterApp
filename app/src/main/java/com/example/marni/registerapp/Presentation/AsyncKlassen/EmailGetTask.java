...
public class EmailGetTask extends AsyncTask<String, Void, String> {
    private final String TAG = getClass().getSimpleName();
    private OnEmailAvailable listener = null;

    public EmailGetTask(OnEmailAvailable listener) {
        this.listener = listener;
    }

    public interface OnEmailAvailable{
        void OnEmailAvailable(Customer customer);
    }
    ...
    protected void onPostExecute(String response){
        ...
        try{
            ...
            for (int i = 0; i < jsonArray.length();i++){
                ...
                Customer c = new Customer(email1);

                listener.OnEmailAvailable(c);
